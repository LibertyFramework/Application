...
$(document).on("focus","[data-ui-autoselect]",function(e){
	var s = $(this);
	setTimeout(function(){s.select();},200);		
	e.preventDefault();
	return false;
});
...
var jMoney = {
	...
	//
	parse:function(value,dec_point) {
		...
		//
		value = parseFloat(value.replace(dec_point,'.'));
	...
	//
	format:function(value,money,dec_point,thousands_sep) {

		//
		return money+" "+this.number_format(value,2,dec_point,thousands_sep);
	},
