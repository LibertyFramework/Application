...
;(function($){
	...
	//
	$(document).on('click','[data-ui-confirm]',function(){
		var s = $(this);
		var v = s.attr('data-ui-confirm').split("|");
	...
	$ui.gridInputRow = function(o) {	
		...
		var s = $(o);			
		var c = $ui.getConfig(o, "data-ui-grid");
		var p = s.parent();
		...
		s.append('<input type="hidden" name="action" value=""/>');
		...
		// register before submit event for cleaning POST data
		var f = s.closest('form').first();
		f.submit(function(){
